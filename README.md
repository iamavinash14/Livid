This project is the front-end of Livid, an imaginary video rental app which is bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
